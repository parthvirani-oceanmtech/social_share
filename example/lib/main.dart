...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion = (await SocialShare.platformVersion) ?? _platformVersion;
                    ...
                    onPressed: () async {
                      await screenshotController.capture().then((image) async {
                        ...
                        if (image != null) {
                          ...
                          SocialShare.shareOnFeedInstagram(url: file.path, message: '').then((data) {
                            print(data);
                          });
                        }
                      });
                    ...
                    onPressed: () async {
                      await screenshotController.capture().then((image) async {
                        ...
                        if (image != null) {
                          ...
                          SocialShare.shareStoryOnInstagram(url: file.path).then((data) {
                            print(data);
                          });
                        }
                      });
                    },
                    child: Text("Share Story On Instagram"),
                  ),
                  RaisedButton(
                    onPressed: () async {
